...
async function getAIResponse(messages) {
    const formattedMessages = [
        {
            role: "system",
            content: "Kamu adalah Sorach1o, asisten AI yang diciptakan oleh Izzul Fahmi menggunakan model LLM Sorachio-1 Beta, yang membantu pengguna dengan informasi dan percakapan yang ramah."
        },
        ...messages.map(msg => ({
            role: msg.role,
            content: msg.content
